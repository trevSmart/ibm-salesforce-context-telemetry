 ...
 *
 * Ús:
 *   node scripts/import-database.js <backup-file>
 *
 ...
 *
 * Exemple:
 *   DATABASE_URL="postgresql://user:pass@host/db" DATABASE_SSL=true node scripts/import-database.js backup.json
 *
...
async function importDatabase() {
	...
	if (!backupFile) {
		...
		console.error('Ús: node scripts/import-database.js <backup-file>');
		process.exit(1);
	}
