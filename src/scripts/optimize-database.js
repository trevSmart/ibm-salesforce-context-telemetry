/**
 * Database optimization script that performs comprehensive database maintenance:
 * 1. Drop duplicate indexes that are covered by more comprehensive indexes (improves write performance)
 * 2. Create performance indexes for JSON operations and session queries (improves read performance)
 *
 ...
 *
 * Usage: node src/scripts/optimize-database.js
 *
