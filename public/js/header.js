      ...
      <nav class="top-nav">
        ...
        <div class="top-nav-actions">
          ...
          <div class="inline-flex rounded-md shadow-xs mr-2">
            <button type="button" class="relative inline-flex items-center rounded-l-md bg-[var(--button-bg)] px-2 py-2 text-gray-400 inset-ring-1 inset-ring-gray-300 hover:bg-gray-50 focus:z-10" style="padding-left: 10px; --radius-md: 99px;" data-action="open-settings">
