    ...
    const avatar = logoUrl
      ? `
        <span class="top-users-avatar top-users-avatar--team" style="padding: 0; background: transparent; border-radius: 0;">
          <img src="${escapeHtml(logoUrl)}" alt="${escapeHtml(teamName)} logo" style="width: 32px; height: 32px; object-fit: contain;" onerror="this.style.display='none'; const fallback=this.nextElementSibling; if (fallback) { fallback.style.display='flex'; }">
