...
function renderTopTeams(teams) {
  ...
  const items = teams.map((team, index) => {
    ...
    return `
      <li class="top-users-item">
        <span class="top-users-avatar" style="background: ${team.color || badgeBackground}; color: #ffffff;">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" focusable="false" style="width: 20px; height: 20px;">
