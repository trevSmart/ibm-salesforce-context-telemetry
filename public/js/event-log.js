	...
	function displayEvents(events, append = false) {
		...
		renderableEvents.forEach(event => {
			...
			row.innerHTML = `
				...
				<td class="hidden border-b border-gray-200 px-3 py-4 text-sm text-gray-500 xl:table-cell log-error-message whitespace-nowrap overflow-hidden text-ellipsis max-w-48" title="${escapedErrorMessage}">${escapedErrorMessage}</td>
